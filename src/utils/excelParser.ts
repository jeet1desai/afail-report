...
const MAIN_SHEET_COLUMN_MAP: { field: keyof MainSheetRow; label: string; patterns: string[] }[] = [
  ...
  { field: "createdBy", label: "Created by", patterns: ["created by", "createdby", "created_by"] },
  {
    ...
    patterns: ["act gds mvmnt date", "actgdsmvmntdate", "act_gds_mvmnt_date", "act gds mvmnt", "actual goods movement date"],
  },
  ...
  { field: "salesOrganization", label: "Sales Organization", patterns: ["sales organization", "salesorganization", "salesorg", "sales_org"] },
  {
    ...
    patterns: ["distribution channel", "distributionchannel", "dist channel", "distchannel"],
  },
  ...
  { field: "shipToParty", label: "Ship-to party", patterns: ["ship to party", "shiptoparty", "ship_to_party"] },
  {
    ...
    patterns: ["region of dlv plant", "regionofdlvplant", "region of dlv.plant", "region of delivery plant"],
  },
  ...
  { field: "newShippingType", label: "New Shipping Type", patterns: ["new shipping type", "newshippingtype", "new_shipping_type"] },
  {
    ...
    patterns: ["special proc indicator", "specialprocindicator", "special_proc_indicator", "special proc. indicator"],
  },
...
export function extractMainSheetData(rows: ParsedRow[]): ExcelParseResult<MainSheetRow> {
  ...
  const createdOnHeader2 =
    findColumn(headers, ["created on_1", "created on 1", "billing created on", "billingcreatedon"]) ||
