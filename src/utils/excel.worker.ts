...
// 4. Main Sheet Extract Config & Function
const MAIN_SHEET_COLUMN_MAP = [
  { field: 'delivery', label: 'Delivery', patterns: ['delivery', 'deliveryno', 'delivery_no'] },
  { field: 'billingDocument', label: 'Billing Document', patterns: ['billing document', 'billingdocument', 'billing_document', 'billing doc'] },
  { field: 'createdBy', label: 'Created by', patterns: ['created by', 'createdby', 'created_by'] },
  { field: 'actGdsMvmntDate', label: 'Act. Gds Mvmnt Date', patterns: ['act gds mvmnt date', 'actgdsmvmntdate', 'act_gds_mvmnt_date', 'act gds mvmnt', 'actual goods movement date'] },
  { field: 'deliveryType', label: 'Delivery Type', patterns: ['delivery type', 'deliverytype', 'delivery_type'] },
  { field: 'billingType', label: 'Billing Type', patterns: ['billing type', 'billingtype', 'billing_type'] },
  { field: 'billedQty', label: 'Billed Qty', patterns: ['billed qty', 'billedqty', 'billed_qty', 'billed quantity'] },
  { field: 'salesOrganization', label: 'Sales Organization', patterns: ['sales organization', 'salesorganization', 'salesorg', 'sales_org'] },
  { field: 'distributionChannel', label: 'Distribution Channel', patterns: ['distribution channel', 'distributionchannel', 'dist channel', 'distchannel'] },
  { field: 'division', label: 'Division', patterns: ['division'] },
  { field: 'soldToParty', label: 'Sold-to party', patterns: ['sold to party', 'soldtoparty', 'sold_to_party'] },
  { field: 'shipToParty', label: 'Ship-to party', patterns: ['ship to party', 'shiptoparty', 'ship_to_party'] },
  { field: 'regionOfDlvPlant', label: 'Region of dlv.plant', patterns: ['region of dlv plant', 'regionofdlvplant', 'region of dlv.plant', 'region of delivery plant'] },
  { field: 'soldToRegion', label: 'Sold To Region', patterns: ['sold to region', 'soldtoregion', 'sold_to_region'] },
  { field: 'shipToRegion', label: 'Ship To Region', patterns: ['ship to region', 'shiptoregion', 'ship_to_region'] },
  { field: 'incoterms', label: 'Incoterms', patterns: ['incoterms', 'incoterm'] },
  ...
  { field: 'shippingType', label: 'Shipping type', patterns: ['shipping type', 'shippingtype', 'shipping_type'] },
  { field: 'newShippingType', label: 'New Shipping Type', patterns: ['new shipping type', 'newshippingtype', 'new_shipping_type'] },
  { field: 'specialProcIndicator', label: 'Special proc. indicator', patterns: ['special proc indicator', 'specialprocindicator', 'special_proc_indicator', 'special proc. indicator'] },
  { field: 'contractType', label: 'Contract Type', patterns: ['contract type', 'contracttype', 'contract_type'] },
  { field: 'materialGroup1', label: 'Material group 1', patterns: ['material group 1', 'materialgroup1', 'material_group_1'] },
  { field: 'productHierarchy', label: 'Product hierarchy', patterns: ['product hierarchy', 'producthierarchy', 'product_hierarchy'] },
  { field: 'geoDistrict', label: 'Geo District', patterns: ['geo district', 'geodistrict', 'geo_district'] },
  { field: 'plant', label: 'Plant', patterns: ['plant'] },
  { field: 'storageLocation', label: 'Storage Location', patterns: ['storage location', 'storagelocation', 'storage_location'] },
  ...
  { field: 'cancelled', label: 'Cancelled', patterns: ['cancelled', 'cancel'] },
  { field: 'postingStatus', label: 'Posting Status', patterns: ['posting status', 'postingstatus', 'posting_status'] },
  ...
  { field: 'minimumFreight', label: 'Minimum Freight', patterns: ['minimum freight', 'minimumfreight', 'minimum_freight'] },
  { field: 'totalFreight', label: 'Total Freight', patterns: ['total freight', 'totalfreight', 'total_freight'] },
  { field: 'messageType', label: 'Message type', patterns: ['message type', 'messagetype', 'message_type'] },
  { field: 'messageText', label: 'Message text', patterns: ['message text', 'messagetext', 'message_text'] },
  { field: 'aopReceivedFlag', label: 'AOP Received Flag', patterns: ['aop received flag', 'aopreceivedflag', 'aop_received_flag'] },
  { field: 'aopReceivedDate', label: 'AOP Received Date', patterns: ['aop received date', 'aopreceiveddate', 'aop_received_date'] },
  { field: 'aopReceivedTime', label: 'AOP Received Time', patterns: ['aop received time', 'aopreceivedtime', 'aop_received_time'] },
];
